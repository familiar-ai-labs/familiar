...
test('keyEventToAccelerator handles Cmd/Ctrl + single letter', () => {
  assert.equal(
    keyEventToAccelerator({ metaKey: true, key: 'j' }),
    'CommandOrControl+J'
  )
  assert.equal(
    keyEventToAccelerator({ ctrlKey: true, key: 's' }),
    'CommandOrControl+S'
  )
})
...
test('keyEventToAccelerator handles Cmd/Ctrl + Shift + letter', () => {
  assert.equal(
    keyEventToAccelerator({ metaKey: true, shiftKey: true, key: 'j' }),
    'CommandOrControl+Shift+J'
  )
  assert.equal(
    keyEventToAccelerator({ ctrlKey: true, shiftKey: true, key: 'p' }),
...
test('keyEventToAccelerator handles Alt + letter', () => {
  assert.equal(
    keyEventToAccelerator({ altKey: true, key: 'x' }),
    'Alt+X'
  )
})
...
test('keyEventToAccelerator handles Cmd/Ctrl + Alt + letter', () => {
  assert.equal(
    keyEventToAccelerator({ metaKey: true, altKey: true, key: 'c' }),
...
test('keyEventToAccelerator handles function keys', () => {
  assert.equal(
    keyEventToAccelerator({ metaKey: true, key: 'F1' }),
    'CommandOrControl+F1'
  )
  assert.equal(
    keyEventToAccelerator({ altKey: true, key: 'F12' }),
    'Alt+F12'
  )
  assert.equal(
    keyEventToAccelerator({ shiftKey: true, key: 'F5' }),
    'Shift+F5'
  )
})
...
test('keyEventToAccelerator handles space key', () => {
  assert.equal(
    keyEventToAccelerator({ metaKey: true, key: ' ' }),
    'CommandOrControl+Space'
  )
  assert.equal(
    keyEventToAccelerator({ ctrlKey: true, shiftKey: true, key: ' ' }),
...
test('keyEventToAccelerator handles arrow keys', () => {
  assert.equal(
    keyEventToAccelerator({ metaKey: true, key: 'ArrowUp' }),
    'CommandOrControl+Up'
  )
  assert.equal(
    keyEventToAccelerator({ altKey: true, key: 'ArrowDown' }),
    'Alt+Down'
  )
  assert.equal(
    keyEventToAccelerator({ shiftKey: true, key: 'ArrowLeft' }),
    'Shift+Left'
  )
  assert.equal(
...
test('keyEventToAccelerator handles special keys', () => {
  assert.equal(
    keyEventToAccelerator({ metaKey: true, key: 'Escape' }),
    'CommandOrControl+Escape'
  )
  assert.equal(
    keyEventToAccelerator({ ctrlKey: true, key: 'Enter' }),
    'CommandOrControl+Return'
  )
  assert.equal(
    keyEventToAccelerator({ altKey: true, key: 'Backspace' }),
    'Alt+Backspace'
  )
  assert.equal(
    keyEventToAccelerator({ shiftKey: true, key: 'Delete' }),
    'Shift+Delete'
  )
  assert.equal(
    keyEventToAccelerator({ metaKey: true, key: 'Tab' }),
...
test('keyEventToAccelerator handles navigation keys', () => {
  assert.equal(
    keyEventToAccelerator({ metaKey: true, key: 'Home' }),
    'CommandOrControl+Home'
  )
  assert.equal(
    keyEventToAccelerator({ ctrlKey: true, key: 'End' }),
    'CommandOrControl+End'
  )
  assert.equal(
    keyEventToAccelerator({ altKey: true, key: 'PageUp' }),
    'Alt+PageUp'
  )
  assert.equal(
    keyEventToAccelerator({ shiftKey: true, key: 'PageDown' }),
    'Shift+PageDown'
  )
})
...
test('keyEventToAccelerator handles numbers', () => {
  assert.equal(
    keyEventToAccelerator({ metaKey: true, key: '1' }),
    'CommandOrControl+1'
  )
  assert.equal(
    keyEventToAccelerator({ ctrlKey: true, shiftKey: true, key: '9' }),
...
test('keyEventToAccelerator returns null for unknown keys', () => {
  assert.equal(
    keyEventToAccelerator({ metaKey: true, key: 'AudioVolumeUp' }),
    null
  )
  assert.equal(
    keyEventToAccelerator({ ctrlKey: true, key: 'Unidentified' }),
    null
  )
})
...
test('keyEventToAccelerator uppercases single character keys', () => {
  assert.equal(
    keyEventToAccelerator({ metaKey: true, key: 'a' }),
    'CommandOrControl+A'
  )
  assert.equal(
    keyEventToAccelerator({ metaKey: true, key: 'A' }),
...
test('formatAcceleratorForDisplay uses Mac symbols on darwin', () => {
  assert.equal(
    formatAcceleratorForDisplay('CommandOrControl+Shift+J', 'darwin'),
    '⌘ + ⇧ + J'
  )
  assert.equal(
    formatAcceleratorForDisplay('Alt+X', 'darwin'),
    '⌥ + X'
  )
  assert.equal(
    formatAcceleratorForDisplay('Command+C', 'darwin'),
    '⌘ + C'
  )
})
...
test('formatAcceleratorForDisplay uses text labels on non-Mac platforms', () => {
  assert.equal(
    formatAcceleratorForDisplay('CommandOrControl+Shift+J', 'win32'),
    'Ctrl + Shift + J'
  )
  assert.equal(
    formatAcceleratorForDisplay('Alt+X', 'linux'),
    'Alt + X'
  )
  assert.equal(
    formatAcceleratorForDisplay('Control+C', 'win32'),
    'Ctrl + C'
  )
})
...
test('formatAcceleratorForDisplay handles complex combinations', () => {
  assert.equal(
    formatAcceleratorForDisplay('CommandOrControl+Alt+Shift+F5', 'darwin'),
    '⌘ + ⌥ + ⇧ + F5'
  )
  assert.equal(
    formatAcceleratorForDisplay('CommandOrControl+Alt+Shift+F5', 'win32'),
    'Ctrl + Alt + Shift + F5'
  )
})
