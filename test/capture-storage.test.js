...
const { buildCaptureFilename, getCaptureDirectory, savePngToDirectory } = require('../src/screenshot/capture-storage');
const { CAPTURE_FILENAME_PREFIX, CAPTURES_DIR_NAME, JIMINY_BEHIND_THE_SCENES_DIR_NAME } = require('../src/const');
